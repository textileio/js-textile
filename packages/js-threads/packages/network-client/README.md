...
Client for interacting with Textile's (remote) Threads gRPC network layer
...
[![npm (scoped)](https://img.shields.io/npm/v/@textile/threads-network-client.svg)](https://www.npmjs.com/package/@textile/threads-network-client)
