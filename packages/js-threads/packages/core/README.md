...
[![npm (scoped)](https://img.shields.io/npm/v/@textile/threads-core.svg)](https://www.npmjs.com/package/@textile/threads-core)

> Core interfaces and classes for Textile's Threads protocol & database
