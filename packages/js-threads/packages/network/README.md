# Threads Network _(threads-network)_
...
[![npm (scoped)](https://img.shields.io/npm/v/@textile/threads-network.svg)](https://www.npmjs.com/package/@textile/threads-network)

> Networking layer for Textile's Threads protocol & database
