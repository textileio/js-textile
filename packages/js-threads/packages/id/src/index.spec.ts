...
describe("Thread ID", function () {
  it("should be able to create a random ID", function () {
  ...
  it("should decode an ID from a base-32 encoded string", function () {
  ...
  it("should be able to extract the encoding", function () {
    const i = ThreadID.fromRandom(ThreadID.Variant.Raw, 16)
  ...
  it("should have a valid variant number", function () {
  ...
  it("should be able to round-trip to and from bytes", function () {
    const i = ThreadID.fromRandom(ThreadID.Variant.Raw, 16)
    const b = i.toBytes()
